...
!!! Note
    [Fonte materiali](https://www.lapadigitale.it/wp-content/uploads/Roberto-Scano-Accessibilità-i-nuovi-obblighi-per-il-procurement-dei-prodotti-ICT-dall’hardware-al-Web.pdf). I materiali sono stati prodotti da [Roberto Scano](https://twitter.com/rscano) in occasione del raduno dei Responsabili della Transizione al Digitale, a Matera l’8 aprile 2019, organizzato nell’ambito dell’iniziativa LaPaDigitale.
...
- [W3C WCAG 2.1 (Web Content Accessibility Guidelines - Linee guida per l'accessibilità dei contenuti web tradotte in italiano) - Raccomandazione del 5 giugno 2018](https://www.w3.org/Translations/WCAG21-it/) 
...
- Il 2 dicembre 2016 è stata pubblicata la [Direttiva (UE) 2016/2102 del Parlamento europeo e del Consiglio, del 26 ottobre 2016, relativa all’accessibilità dei siti web e delle applicazioni mobili degli enti pubblici](https://eur-lex.europa.eu/legal-content/IT/TXT/HTML/?uri=CELEX:32016L2102&from=IT) entrata in vigore il 22 dicembre 2016, (WAD - Web Accessibility Directive).
- [Link alla Direttiva (UE) 2016/2102 del Parlamento europeo e del Consiglio, del 26 ottobre 2016](http://eur-lex.europa.eu/legal-content/IT/TXT/?uri=OJ:L:2016:327:TOC).
...
In assenza della pubblicazione della specifica tecnica dovrà essere presa come riferimento la norma europea “[EN 301 549 V1.1.2 (2015-04), Accessibility requirements suitable for public procurement of ICT products and services in Europe](http://www.etsi.org/deliver/etsi_en/301500_301599/301549/01.01.02_60/en_301549v010102p.pdf)” (le pertinenti disposizioni per i contenuti dei siti web e per i contenuti delle applicazioni mobili).
...
[HARMONISED EUROPEAN STANDARD - Accessibility requirements for ICT products and services](https://www.etsi.org/deliver/etsi_en/301500_301599/301549/02.01.02_60/en_301549v020102p.pdf).


## WCAG 2.1. Nuovi (17) criteri di successo
[W3C WCAG 2.1 (Web Content Accessibility Guidelines - Linee guida per l'accessibilità dei contenuti Web tradotte in italiano)](https://www.w3.org/Translations/WCAG21-it/).
...
- [1.3.4 Orientamento (AA)](https://www.w3.org/Translations/WCAG21-it/#orientation)
- [1.3.5 Identificare lo scopo degli input (AA)](https://www.w3.org/Translations/WCAG21-it/#identify-input-purpose)
- [1.3.6 Identificare lo scopo (AAA)](https://www.w3.org/Translations/WCAG21-it/#identify-purpose)
- [1.4.10 Ricalcolo del flusso (AA)](https://www.w3.org/Translations/WCAG21-it/#reflow)
- [1.4.11 Contrasto in contenuti non testuali (AA)](https://www.w3.org/Translations/WCAG21-it/#non-text-contrast)
- [1.4.12 Spaziatura del testo (AA)](https://www.w3.org/Translations/WCAG21-it/#text-spacing)
- [1.4.13 Contenuto con Hover o Focus (AA)](https://www.w3.org/Translations/WCAG21-it/#content-on-hover-or-focus)
- [2.1.4 Tasti di scelta rapida (A)](https://www.w3.org/Translations/WCAG21-it/#character-key-shortcuts)
- [2.2.6 Termine del tempo (AAA)](https://www.w3.org/Translations/WCAG21-it/#timeouts)
- [2.3.3 Animazione da interazioni (AAA)](https://www.w3.org/Translations/WCAG21-it/#animation-from-interactions)
- [2.5.1 Movimenti del puntatore (A)](https://www.w3.org/Translations/WCAG21-it/#pointer-gestures)
- [2.5.2 Cancellazione delle azioni del puntatore (A)](https://www.w3.org/Translations/WCAG21-it/#pointer-cancellation)
- [2.5.3 Etichetta nel nome (A)](https://www.w3.org/Translations/WCAG21-it/#label-in-name)
- [2.5.4 Azionamento da movimento (A)](https://www.w3.org/Translations/WCAG21-it/#motion-actuation)
- [2.5.5 Dimensione dell'obiettivo (AAA)](https://www.w3.org/Translations/WCAG21-it/#target-size) 
- [2.5.6 Meccanismi di input simultanei (AAA)](https://www.w3.org/Translations/WCAG21-it/#concurrent-input-mechanisms)
- [4.1.3 Messaggi di stato (AA)](https://www.w3.org/Translations/WCAG21-it/#status-messages)
...
[LEGGE 9 gennaio 2004, n. 4 ((Disposizioni per favorire e semplificare l'accesso degli utenti e, in particolare, delle persone con disabilità' agli strumenti informatici))](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:legge:2004-01-09;4!vig=).
...
Per questo motivo, è cruciale il ruolo dei nuovi [responsabili della transizione digitale (che dovrebbero essere già stati nominati da ciascuna amministrazione ai sensi del nuovo art. 17 CAD)](https://docs.italia.it/italia/piano-triennale-ict/codice-amministrazione-digitale-docs/it/v2017-12-13/_rst/capo1_sezione3_art17.html) con l’obiettivo di curare la transizione alla modalità operativa digitale e i conseguenti processi di riorganizzazione finalizzati alla realizzazione di un’amministrazione digitale e aperta, di servizi facilmente utilizzabili e di qualità, attraverso una maggiore efficienza ed economicità.
...
Si ritiene, pertanto, [fondata la richiamata Segnalazione e si invita il Comune di Palermo “a porvi rimedio tempestivamente e comunque non oltre trenta giorni.”](https://www.agid.gov.it/sites/default/files/repository_files/invito_n.1-2018_comune_palermo.0009364.10-05-2018.pdf), rendendo accessibili i documenti emessi dai propri uffici e pubblicati in albo pretorio del proprio sito istituzionale, dandone conferma alla scrivente Agenzia. 
...
[Vedi documento ANAC](https://www.anticorruzione.it/portal/rest/jcr/repository/collaboration/Digital%20Assets/anacdocs/Attivita/Trasparenza/Vigilanza/VigilanzaUfficio/2014/AziendeSanitarie/Rapporti/Azienda-USL-2-di-LuccaRapporto.pdf).


## Faq AgID su Accessibilità
[Vedi le domande frequenti su accessibilità, sul portale AgID](https://www.agid.gov.it/it/domande-frequenti/accessibilit%C3%A0).
...
[http://checkers.eiii.eu/en/pdf](http://checkers.eiii.eu/en/pdf) check servizio online di verifica.

## Strumenti open source per le verifiche di accessibilità:
[Strumenti open source per le verifiche di accessibilità](https://drive.google.com/file/d/1SPwrcoGE5f4AiSuX3C9lMJ-zWFQ0bCqb/view) (a cura di AgID):
...
- Web Developer Toolbar: [Firefox](https://addons.mozilla.org/it/firefox/addon/web-developer/); [Chrome](https://chrome.google.com/webstore/detail/web-developer/bfbameneiokkgbdmiekhjnmfkcnldhhm?hl=it);
- [Siteimprove Browser Extensions](https://chrome.google.com/webstore/detail/siteimprove-accessibility/efcfolpjihicnikpmhnmphjhhpiclljc): estensione per il browser Chrome
- [JAWS Screen Reader](https://www.freedomscientific.com/products/software/jaws/)
- [Ulteriori strumenti](https://www.w3.org/WAI/ER/tools/) sono elencati all’interno del sito del [W3C](https://www.w3.org/WAI/ER/tools/)
...
[Adozione delle Linee Guida sull’accessibilità degli strumenti informatici](https://trasparenza.agid.gov.it/archivio28_provvedimenti-amministrativi_0_122158_725_1.html)
