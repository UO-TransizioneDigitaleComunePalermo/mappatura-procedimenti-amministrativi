...
Le Linee guida di design per i servizi digitali della PA adottano l’approccio [**`human-centered`**](https://it.wikipedia.org/wiki/Human-centered_design) :fontawesome-solid-street-view: con i seguenti obiettivi:
