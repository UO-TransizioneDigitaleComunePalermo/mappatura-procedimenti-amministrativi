...
In questa pagina viene illustrato il percorso realizzato dal Comune di Palermo per l’analisi dei procedimenti amministrativi.
...
Viene costruita su Google spreadsheet (fogli su Google Drive) una scheda per il monitoraggio delle attività in corso.
